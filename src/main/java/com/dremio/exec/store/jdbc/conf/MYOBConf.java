...
@SourceType(value = "MYOBARP", label = "MYOB",uiConfig = "myob-layout.json")
public class MYOBConf extends AbstractArpConf<MYOBConf> {
  private static final String ARP_FILENAME = "arp/implementation/myob-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.myob.MYOBDriver";
